...
frames = [start_page, choosing_player_page, choosing_year_page, Results_page, Results_1_page, Results_2_page, Results_3_page, Results_4_page, Results_5_page, instruction_page, confirmation_page, calculation_page]
...
def input(player, year):
    ...
    player = player_to_player[player]
...
confirms_3.grid(row=4, column=1)
confirms_4 = Label(confirmation_page)
confirms_4.grid(row=5, column=1)
