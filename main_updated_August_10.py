...
def input(player_name, year):
    ...
    Result_5.config(text=f'Predicted percentage of 4-0 per game: {all_result_1[4]}')
    Result_6.config(text=f'Predicted percentage of 4-1 per game: {all_result_1[5]}')
    Result_7.config(text=f'Predicted percentage of 4-2 per game: {all_result_1[6]}')
    Result_8.config(text=f'Predicted percentage of 4-3 per game: {all_result_1[7]}')
    Result_9.config(text=f'Predicted percentage of 4-4 per game: {all_result_1[8]}')
    Result_10.config(text=f"Predicted team's winning percentage: {all_result_1[9]}")
    ...
    Result_5_DB.config(text=f'Predicted percentage of 4-0 per game: {all_result_2[0][4]}')
    Result_6_DB.config(text=f'Predicted percentage of 4-1 per game: {all_result_2[0][5]}')
    Result_7_DB.config(text=f'Predicted percentage of 4-2 per game: {all_result_2[0][6]}')
    Result_8_DB.config(text=f'Predicted percentage of 4-3 per game: {all_result_2[0][7]}')
    Result_9_DB.config(text=f'Predicted percentage of 4-4 per game: {all_result_2[0][8]}')
    Result_10_DB.config(text=f"Predicted team's winning percentage: {all_result_2[0][9]}")
    ...
    Result_5_D.config(text=f'Predicted percentage of 4-0 per game: {all_result_2[1][4]}')
    Result_6_D.config(text=f'Predicted percentage of 4-1 per game: {all_result_2[1][5]}')
    Result_7_D.config(text=f'Predicted percentage of 4-2 per game: {all_result_2[1][6]}')
    Result_8_D.config(text=f'Predicted percentage of 4-3 per game: {all_result_2[1][7]}')
    Result_9_D.config(text=f'Predicted percentage of 4-4 per game: {all_result_2[1][8]}')
    Result_10_D.config(text=f"Predicted team's winning percentage: {all_result_2[1][9]}")
    ...
    Result_5_T.config(text=f'Predicted percentage of 4-0 per game: {all_result_2[2][4]}')
    Result_6_T.config(text=f'Predicted percentage of 4-1 per game: {all_result_2[2][5]}')
    Result_7_T.config(text=f'Predicted percentage of 4-2 per game: {all_result_2[2][6]}')
    Result_8_T.config(text=f'Predicted percentage of 4-3 per game: {all_result_2[2][7]}')
    Result_9_T.config(text=f'Predicted percentage of 4-4 per game: {all_result_2[2][8]}')
    Result_10_T.config(text=f"Predicted team's winning percentage: {all_result_2[2][9]}")
    ...
    Result_5_C.config(text=f'Predicted percentage of 4-0 per game: {all_result_2[3][4]}')
    Result_6_C.config(text=f'Predicted percentage of 4-1 per game: {all_result_2[3][5]}')
    Result_7_C.config(text=f'Predicted percentage of 4-2 per game: {all_result_2[3][6]}')
    Result_8_C.config(text=f'Predicted percentage of 4-3 per game: {all_result_2[3][7]}')
    Result_9_C.config(text=f'Predicted percentage of 4-4 per game: {all_result_2[3][8]}')
    Result_10_C.config(text=f"Predicted team's winning percentage: {all_result_2[3][9]}")
    ...
    Result_5_G.config(text=f'Predicted percentage of 4-0 per game: {all_result_2[4][4]}')
    Result_6_G.config(text=f'Predicted percentage of 4-1 per game: {all_result_2[4][5]}')
    Result_7_G.config(text=f'Predicted percentage of 4-2 per game: {all_result_2[4][6]}')
    Result_8_G.config(text=f'Predicted percentage of 4-3 per game: {all_result_2[4][7]}')
    Result_9_G.config(text=f'Predicted percentage of 4-4 per game: {all_result_2[4][8]}')
    Result_10_G.config(text=f"Predicted team's winning percentage: {all_result_2[4][9]}")
    ...
    for data in list_of_ERA:
        ...
        elif data <= 2.5 and data > 2.25:
            ERA_Ranking.append("A")
        elif data <= 2.75 and data > 2.5:
            ERA_Ranking.append("B")
        elif data <= 3 and data > 2.75:
            ERA_Ranking.append("C")
        elif data <= 3.5 and data > 3:
    ...
    for data_field in list_of_field:
        ...
        elif data_field <= 50 and data_field > 40:
            Field_Ranking.append("A")
        elif data_field <= 60 and data_field > 50:
            Field_Ranking.append("B")
        elif data_field <= 70 and data_field > 60:
            Field_Ranking.append("C")
        elif data_field <= 80 and data_field > 70:
...
Result_4.pack()
Result_5 = Label(Results_page, text='Predicted percentage of 4-0 per game: ')
Result_5.pack()
Result_6 = Label(Results_page, text='Predicted percentage of 4-1 per game: ')
Result_6.pack()
Result_7 = Label(Results_page, text='Predicted percentage of 4-2 per game: ')
Result_7.pack()
Result_8 = Label(Results_page, text='Predicted percentage of 4-3 per game: ')
Result_8.pack()
Result_9 = Label(Results_page, text='Predicted percentage of 4-4 per game: ')
Result_9.pack()
Result_10 = Label(Results_page, text="Predicted team's winning percentage: ")
Result_10.pack()
...
Result_4_DB.pack()
Result_5_DB = Label(Results_1_page, text='Predicted percentage of 4-0 per game: ')
Result_5_DB.pack()
Result_6_DB = Label(Results_1_page, text='Predicted percentage of 4-1 per game: ')
Result_6_DB.pack()
Result_7_DB = Label(Results_1_page, text='Predicted percentage of 4-2 per game: ')
Result_7_DB.pack()
Result_8_DB = Label(Results_1_page, text='Predicted percentage of 4-3 per game: ')
Result_8_DB.pack()
Result_9_DB = Label(Results_1_page, text='Predicted percentage of 4-4 per game: ')
Result_9_DB.pack()
Result_10_DB = Label(Results_1_page, text="Predicted team's winning percentage: ")
Result_10_DB.pack()
...
Result_4_D.pack()
Result_5_D = Label(Results_2_page, text='Predicted percentage of 4-0 per game: ')
Result_5_D.pack()
Result_6_D = Label(Results_2_page, text='Predicted percentage of 4-1 per game: ')
Result_6_D.pack()
Result_7_D = Label(Results_2_page, text='Predicted percentage of 4-2 per game: ')
Result_7_D.pack()
Result_8_D = Label(Results_2_page, text='Predicted percentage of 4-3 per game: ')
Result_8_D.pack()
Result_9_D = Label(Results_2_page, text='Predicted percentage of 4-4 per game: ')
Result_9_D.pack()
Result_10_D = Label(Results_2_page, text="Predicted team's winning percentage: ")
Result_10_D.pack()
...
Result_4_T.pack()
Result_5_T = Label(Results_3_page, text='Predicted percentage of 4-0 per game: ')
Result_5_T.pack()
Result_6_T = Label(Results_3_page, text='Predicted percentage of 4-1 per game: ')
Result_6_T.pack()
Result_7_T = Label(Results_3_page, text='Predicted percentage of 4-2 per game: ')
Result_7_T.pack()
Result_8_T = Label(Results_3_page, text='Predicted percentage of 4-3 per game: ')
Result_8_T.pack()
Result_9_T = Label(Results_3_page, text='Predicted percentage of 4-4 per game: ')
Result_9_T.pack()
Result_10_T = Label(Results_3_page, text="Predicted team's winning percentage: ")
Result_10_T.pack()
...
Result_4_C.pack()
Result_5_C = Label(Results_4_page, text='Predicted percentage of 4-0 per game: ')
Result_5_C.pack()
Result_6_C = Label(Results_4_page, text='Predicted percentage of 4-1 per game: ')
Result_6_C.pack()
Result_7_C = Label(Results_4_page, text='Predicted percentage of 4-2 per game: ')
Result_7_C.pack()
Result_8_C = Label(Results_4_page, text='Predicted percentage of 4-3 per game: ')
Result_8_C.pack()
Result_9_C = Label(Results_4_page, text='Predicted percentage of 4-4 per game: ')
Result_9_C.pack()
Result_10_C = Label(Results_4_page, text="Predicted team's winning percentage: ")
Result_10_C.pack()
...
Result_4_G.pack()
Result_5_G = Label(Results_5_page, text='Predicted percentage of 4-0 per game: ')
Result_5_G.pack()
Result_6_G = Label(Results_5_page, text='Predicted percentage of 4-1 per game: ')
Result_6_G.pack()
Result_7_G = Label(Results_5_page, text='Predicted percentage of 4-2 per game: ')
Result_7_G.pack()
Result_8_G = Label(Results_5_page, text='Predicted percentage of 4-3 per game: ')
Result_8_G.pack()
Result_9_G = Label(Results_5_page, text='Predicted percentage of 4-4 per game: ')
Result_9_G.pack()
Result_10_G = Label(Results_5_page, text="Predicted team's winning percentage: ")
Result_10_G.pack()
...
Title.pack()
DeNA_ERA = Label(Results_6_page, text='DeNA ERA: ')
DeNA_ERA.pack()
DeNA_field = Label(Results_6_page, text='DeNA fielding errors: ')
DeNA_field.pack()
DeNA_information = Label(Results_6_page, text='___ will contribute _% of games against DeNA: ')
DeNA_information.pack()
Chunichi_ERA = Label(Results_6_page, text='Chunichi ERA: ')
Chunichi_ERA.pack()
Chunichi_field = Label(Results_6_page, text='Chunichi fielding errors: ')
Chunichi_field.pack()
Chunichi_information = Label(Results_6_page, text='___ will contribute _% of games against Chunichi: ')
Chunichi_information.pack()
Hanshin_ERA = Label(Results_6_page, text='Hanshin ERA: ')
Hanshin_ERA.pack()
Hanshin_field = Label(Results_6_page, text='Hanshin fielding errors: ')
Hanshin_field.pack()
Hanshin_information = Label(Results_6_page, text='___ will contribute _% of games against Hanshin: ')
Hanshin_information.pack()
Hiroshima_ERA = Label(Results_6_page, text='Hiroshima ERA: ')
Hiroshima_ERA.pack()
Hiroshima_field = Label(Results_6_page, text='Hiroshima fielding errors: ')
Hiroshima_field.pack()
Hiroshima_information = Label(Results_6_page, text='___ will contribute _% of games against Hiroshima: ')
Hiroshima_information.pack()
Yomiuri_ERA = Label(Results_6_page, text='Yomiuri ERA: ')
Yomiuri_ERA.pack()
Yomiuri_field = Label(Results_6_page, text='Yomiuri fielding errors: ')
Yomiuri_field.pack()
Yomiuri_information = Label(Results_6_page, text='___ will contribute _% of games against Yomiuri: ')
...
def calculation(player, year):
    ...
    if year == 3 or index == 7:
        ...
        result = [round(batting, 3), int(total_predicted_homerun), int(total_predicted_RBI), int(total_predicted_hit), round(1 - (prob_4_4 + prob_4_3 + prob_4_2 + prob_4_1), 3), round(prob_4_1, 3), round(prob_4_2, 3), round(prob_4_3, 3), round(prob_4_4, 3), round(total_percentage, 3), int(Total_number_of_games_contribution), int(Total_number_of_games_contribution * total_percentage)]
        return result
