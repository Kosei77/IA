...
stat_2024 = [["Munetaka Murakami", 345, 81, 0.235, 21, 83, 0], ["Tetsuto Yamada", 211, 45, 0.213, 9, 26, 25],
             ["Domingo Santana", 270, 86, 0.319, 11, 42, 0], ["Jose Osuna", 376, 99, 0.263, 13, 50, 0], ["Nori Aoki", 104, 20, 0.192, 0, 9, 0],
             ["Yasutaka Shiomi", 101, 27, 0.267, 3, 8, 64], ["Yuhei Nakamura", 226, 54, 0.239, 0, 21, 5], ["Hideki Nagaoka", 300, 83, 0.277, 3, 31, 0]]
...
stat_2023 = [["Munetaka Murakami", 496, 127, 0.256, 31, 84, 0], ["Tetsuto Yamada", 376, 87, 0.231, 14, 40, 30],
             ["Domingo Santana", 467, 140, 0.300, 18, 66, 0], ["Jose Osuna", 501, 127, 0.253, 23, 71, 10],
             ["Nori Aoki", 217, 55, 0.253, 3, 19, 0], ["Yasutaka Shiomi", 186, 56, 0.301, 8, 31, 91],
             ["Yuhei Nakamura", 310, 70, 0.226, 4, 33, 7], ["Hideki Nagaoka", 445, 101, 0.227, 3, 35, 0]]
...
stat_2022 = [["Munetaka Murakami", 487, 155, 0.318, 56, 134], ["Tetsuto Yamada", 469, 114, 0.243, 23, 65],
             ["Domingo Santana", 189, 52, 0.275, 15, 35], ["Jose Osuna", 496, 135, 0.272, 20, 74],
             ["Nori Aoki", 222, 55, 0.248, 5, 22], ["Yasutaka Shiomi", 508, 140, 0.276, 16, 54],
             ["Yuhei Nakamura", 266, 70, 0.263, 5, 28], ["Hideki Nagaoka", 511, 123, 0.241, 9, 48]]
...
frames = [start_page, choosing_player_page, choosing_year_page, Results_page, Results_1_page, Results_2_page, Results_3_page, Results_4_page, Results_5_page, Results_6_page, instruction_page, confirmation_page]
...
def input(player_name, year):
    ...
    Result_5.config(text=f"Predicted team's winning percentage: {round(all_result_1[4]* 100,3)}%")
    Result_6.config(text=f'Predicted percentage of 4-0 per game: {round(all_result_1[5] * 100,3)}%')
    Result_7.config(text=f'Predicted percentage of 4-1 per game: {round(all_result_1[6]* 100,3)}%')
    Result_8.config(text=f'Predicted percentage of 4-2 per game: {round(all_result_1[7]* 100,3)}%')
    Result_9.config(text=f'Predicted percentage of 4-3 per game: {round(all_result_1[8]* 100,3)}%')
    Result_10.config(text=f"Predicted percentage of 4-4 per game: {round(all_result_1[9]* 100,3)}%")
    ...
    Result_5_DB.config(text=f"Predicted team's winning percentage: {round(all_result_2[0][4]* 100, 3)}%")
    Result_6_DB.config(text=f'Predicted percentage of 4-0 per game: {round(all_result_2[0][5]* 100, 3)}%')
    Result_7_DB.config(text=f'Predicted percentage of 4-1 per game: {round(all_result_2[0][6]* 100, 3)}%')
    Result_8_DB.config(text=f'Predicted percentage of 4-2 per game: {round(all_result_2[0][7]* 100, 3)}%')
    Result_9_DB.config(text=f'Predicted percentage of 4-3 per game: {round(all_result_2[0][8]* 100, 3)}%')
    Result_10_DB.config(text=f"Predicted percentage of 4-4 per game: {round(all_result_2[0][9]* 100, 3)}%")
    ...
    Result_5_D.config(text=f"Predicted team's winning percentage: {round(all_result_2[1][4]* 100, 3)}%")
    Result_6_D.config(text=f'Predicted percentage of 4-0 per game: {round(all_result_2[1][5]* 100, 3)}%')
    Result_7_D.config(text=f'Predicted percentage of 4-1 per game: {round(all_result_2[1][6]* 100, 3)}%')
    Result_8_D.config(text=f'Predicted percentage of 4-2 per game: {round(all_result_2[1][7]* 100, 3)}%')
    Result_9_D.config(text=f'Predicted percentage of 4-3 per game: {round(all_result_2[1][8]* 100, 3)}%')
    Result_10_D.config(text=f"Predicted percentage of 4-4 per game: {round(all_result_2[1][9]* 100, 3)}%")
    ...
    Result_5_T.config(text=f"Predicted team's winning percentage: {round(all_result_2[2][4]* 100, 3)}%")
    Result_6_T.config(text=f'Predicted percentage of 4-0 per game: {round(all_result_2[2][5]* 100, 3)}%')
    Result_7_T.config(text=f'Predicted percentage of 4-1 per game: {round(all_result_2[2][6]* 100, 3)}%')
    Result_8_T.config(text=f'Predicted percentage of 4-2 per game: {round(all_result_2[2][7]* 100, 3)}%')
    Result_9_T.config(text=f'Predicted percentage of 4-3 per game: {round(all_result_2[2][8]* 100, 3)}%')
    Result_10_T.config(text=f"Predicted percentage of 4-4 per game: {round(all_result_2[2][9]* 100, 3)}%")
    ...
    Result_5_C.config(text=f"Predicted team's winning percentage: {round(all_result_2[3][4]* 100, 3)}%")
    Result_6_C.config(text=f'Predicted percentage of 4-0 per game: {round(all_result_2[3][5]* 100, 3)}%')
    Result_7_C.config(text=f'Predicted percentage of 4-1 per game: {round(all_result_2[3][6]* 100, 3)}%')
    Result_8_C.config(text=f'Predicted percentage of 4-2 per game: {round(all_result_2[3][7]* 100, 3)}%')
    Result_9_C.config(text=f'Predicted percentage of 4-3 per game: {round(all_result_2[3][8]* 100, 3)}%')
    Result_10_C.config(text=f"Predicted percentage of 4-4 per game: {round(all_result_2[3][9]* 100, 3)}%")
    ...
    Result_5_G.config(text=f"Predicted team's winning percentage: {round(all_result_2[4][4]* 100, 3)}%")
    Result_6_G.config(text=f'Predicted percentage of 4-0 per game: {round(all_result_2[4][5]* 100, 3)}%')
    Result_7_G.config(text=f'Predicted percentage of 4-1 per game: {round(all_result_2[4][6]* 100, 3)}%')
    Result_8_G.config(text=f'Predicted percentage of 4-2 per game: {round(all_result_2[4][7]* 100, 3)}%')
    Result_9_G.config(text=f'Predicted percentage of 4-3 per game: {round(all_result_2[4][8]* 100, 3)}%')
    Result_10_G.config(text=f"Predicted percentage of 4-4 per game: {round(all_result_2[4][9]* 100, 3)}%")
    ...
    if year == 3 or player == 'player 7':
        list_of_ERA = [DeNA_average_ERA_3, Chunichi_average_ERA_3, Hanshin_average_ERA_3, Hiroshima_average_ERA_3, Yomiuri_average_ERA_3]
        list_of_field = [DeNA_fielding_3, Chunichi_fielding_3, Hanshin_fielding_3, Hiroshima_fielding_3, Yomiuri_fielding_3]

    elif year == 4 or player == 'player 3' or player == 'player 4':
        list_of_ERA = [DeNA_average_ERA_4, Chunichi_average_ERA_4, Hanshin_average_ERA_4, Hiroshima_average_ERA_4, Yomiuri_average_ERA_4]
        list_of_field = [DeNA_fielding_4, Chunichi_fielding_4, Hanshin_fielding_4, Hiroshima_fielding_4, Yomiuri_fielding_4]

    elif year == 5:
        list_of_ERA = [DeNA_average_ERA_5, Chunichi_average_ERA_5, Hanshin_average_ERA_5, Hiroshima_average_ERA_5, Yomiuri_average_ERA_5]
        list_of_field = [DeNA_fielding_5, Chunichi_fielding_5, Hanshin_fielding_5, Hiroshima_fielding_5, Yomiuri_fielding_5]
    ...
    DeNA_ERA.config(text=f'DeNA ERA: {round(list_of_ERA[0],2)}  DeNA ERA Ranking: {ERA_Ranking[0]}')
    DeNA_field.config(text=f'DeNA fielding errors: {int(list_of_field[0])}  DeNA fielding Ranking: {Field_Ranking[0]}')
    DeNA_information.config(text=f'{player_name} will contribute {round((all_result_2[0][11]/25)*100,3)}% of games against DeNA')
    Chunichi_ERA.config(text=f'Chunichi ERA: {round(list_of_ERA[1],2)}  Chunichi ERA Ranking: {ERA_Ranking[1]}')
    Chunichi_field.config(text=f'Chunichi fielding errors: {int(list_of_field[1])}  Chunichi fielding Ranking: {Field_Ranking[1]}')
    ...
    Hanshin_ERA.config(text=f'Hanshin ERA: {round(list_of_ERA[2],2)}  Hanshin ERA Ranking: {ERA_Ranking[2]} ')
    Hanshin_field.config(text=f'Hanshin fielding errors: {int(list_of_field[2])}  Hanshin fielding Ranking: {Field_Ranking[2]}')
    Hanshin_information.config(text=f'{player_name} will contribute {round((all_result_2[2][11]/25)*100,3)}% of games against Hanshin: ')
    Hiroshima_ERA.config(text=f'Hiroshima ERA: {round(list_of_ERA[3],2)}  Hiroshima ERA Ranking: {ERA_Ranking[3]}')
    Hiroshima_field.config(text=f'Hiroshima fielding errors: {int(list_of_field[3])}  Hiroshima fielding Ranking: {Field_Ranking[3]}')
    ...
    Yomiuri_ERA.config(text=f'Yomiuri ERA: {round(list_of_ERA[4],2)}  Yomiuri ERA Ranking: {ERA_Ranking[4]}')
    Yomiuri_field.config(text=f'Yomiuri fielding errors: {int(list_of_field[4])}  Yomiuri fielding Ranking: {Field_Ranking[4]}')
...
def clicked():
    '''Evaluating whether the input is valid or not when choosing the player for prediction.
    If valid, the system will proceed, otherwise a message box will come up
    '''
    player_name = Entrys.get()
    player_name = player_name.lower()
    if (player_name == 'player 1' or player_name == 'player 2' or player_name == 'player 3' or player_name == 'player 4' or player_name == 'player 5' or
            player_name == 'player 6' or player_name == 'player 7' or player_name == 'player 8'):
        Entrys.delete(0, END)
        player_number_name = {'player 1': 'Munetaka Murakami No.55 Infielder', 'player 2': 'Tetsuto Yamada No.1 Infielder',
                              'player 3': 'Domingo Santana No.25 Outfielder', 'player 4': 'Jose Osuna No.13 Infielder',
                              'player 5': 'Nori Aoki No.23 Outfielder', 'player 6': 'Yasutaka Shiomi No.9 Outfielder',
                              'player 7': 'Yuhei Nakamura No.27 Catcher', 'player 8': 'Hideki Nagaoka No.7 Infielder'}
        confirms_2.config(text=player_number_name[player_name])
    elif (player_name == 'munetaka murakami' or player_name == 'tetsuto yamada' or player_name == 'domingo santana' or player_name == 'jose osuna' or
          player_name == 'nori aoki' or player_name == 'yasutaka shiomi' or player_name == 'yuhei nakamura' or player_name == 'hideki nagaoka'):
        Entrys.delete(0, END)
        player_number_name = {'munetaka murakami': 'Munetaka Murakami No.55 Infielder', 'tetsuto Yamada': 'Tetsuto Yamada No.1 Infielder',
                              'domingo santana': 'Domingo Santana No.25 Outfielder', 'jose osuna': 'Jose Osuna No.13 Infielder',
                              'nori aoki': 'Nori Aoki No.23 Outfielder', 'yasutaka shiomi': 'Yasutaka Shiomi No.9 Outfielder',
                              'yuhei nakamura': 'Yuhei Nakamura No.27 Catcher', 'hideki nagaoka': 'Hideki Nagaoka No.7 Infielder'}
        confirms_2.config(text=player_number_name[player_name])
    else:
        messagebox.showwarning("Type in error", "Please type in the correct input from player 1 to player 8 or the full name of the player")

# Setting up the choosing the player page
choosing_player_page.config(bg='#0F1350')
choose_player_lbl = Label(choosing_player_page, text='Pick a player that you want to predict its future performance.', fg='white', bg='#0F1350')
choose_player_lbl.pack()

information = ["Player 1: Munetaka Murakami No.55 Infielder", "Player 2: Tetsuto Yamada No.1 Infielder", "Player 3: Domingo Santana No.25 Outfielder",
        "Player 4: Jose Osuna No.13 Infielder", "Player 5: Nori Aoki No.23 Outfielder", "Player 6: Yasutaka Shiomi No.9 Outfielder",
        "Player 7: Yuhei Nakamura No.27 Catcher", "Player 8: Hideki Nagaoka No.7 Infielder"]
...
Instruction = Label(choosing_player_page, text="Type in the entry below one of the player above. "
                                               "Type in player and the number or the full name of the player..", fg='white', bg='#0F1350')
Instruction.pack()

Instruction_2 = Label(choosing_player_page, text="If you want to pick Munetaka Murakami, type full name or Player 1.", fg='white', bg='#0F1350')
Instruction_2.pack()
...
def clicked():
    '''Evaluating whether the input is valid or not when choosing the number of years of past data used for prediction.
        If valid, the system will proceed, otherwise a message box will come up
        '''
...
year = Label(choosing_year_page, text='How many numbers of years of data do you want the system to use to', fg='white', bg='#0F1350')
year.pack()
...
confirm = Label(confirmation_page, text='Please confirm the information below is correct', bg='#E6002D', fg='white')
confirm.pack()
confirms_1 = Label(confirmation_page, text='The selected player for the simulator is', bg='#E6002D', fg='white')
confirms_1.pack()
confirms_2 = Label(confirmation_page, bg='#E6002D', fg='#0F1350')
confirms_2.pack()
blank = Label(confirmation_page, text='', bg='#E6002D')
blank.pack()
confirms_3 = Label(confirmation_page, text='The number of years of past data that will be used in the simulator is', bg='#E6002D', fg='white')
confirms_3.pack()
confirms_4 = Label(confirmation_page, bg='#E6002D', fg='#0F1350')
confirms_4.pack()
Click_input = Label(confirmation_page, text='Click the input button to see the results on the next page', bg='#E6002D', fg='white')
Click_input.pack()
...
Title_result.pack()
Result_1 = Label(Results_page, text='Predicted batting average: ', bg='#00A051', fg='#0F1350')
Result_1.pack()
Result_2 = Label(Results_page, text='Predicted number of homeruns: ', bg='#00A051', fg='#0F1350')
Result_2.pack()
Result_3 = Label(Results_page, text='Predicted RBI: ', bg='#00A051', fg='#0F1350')
Result_3.pack()
Result_4 = Label(Results_page, text='Predicted number of hits: ', bg='#00A051', fg='#0F1350')
Result_4.pack()
Result_5 = Label(Results_page, text="Predicted team's winning percentage: ", bg='#00A051', fg='#0F1350')
Result_5.pack()
Result_6 = Label(Results_page, text='Predicted percentage of 4-0 per game: ', bg='#00A051', fg='#0F1350')
Result_6.pack()
Result_7 = Label(Results_page, text='Predicted percentage of 4-1 per game: ', bg='#00A051', fg='#0F1350')
Result_7.pack()
Result_8 = Label(Results_page, text='Predicted percentage of 4-2 per game: ', bg='#00A051', fg='#0F1350')
Result_8.pack()
Result_9 = Label(Results_page, text='Predicted percentage of 4-3 per game: ', bg='#00A051', fg='#0F1350')
Result_9.pack()
Result_10 = Label(Results_page, text='Predicted percentage of 4-4 per game: ', bg='#00A051', fg='#0F1350')
Result_10.pack()
Result_11 = Label(Results_page, text='Number of games the player will contribute to the team out of 143 games: ', bg='#00A051', fg='#0F1350')
Result_11.pack()
Result_12 = Label(Results_page, text="Number of games the player will contribute to the team's victory out of 143 games: ", bg='#00A051', fg='#0F1350')
Result_12.pack()
...
Title_result_DB = Label(Results_1_page, text='Overall result against Yokohama DeNA Basyatrs', bg='#004583', fg='white')
Title_result_DB.pack()
Result_1_DB = Label(Results_1_page, text='Predicted batting average: ', bg='#004583', fg='#ECB819')
Result_1_DB.pack()
Result_2_DB = Label(Results_1_page, text='Predicted number of homeruns: ', bg='#004583', fg='#ECB819')
Result_2_DB.pack()
Result_3_DB = Label(Results_1_page, text='Predicted RBI: ', bg='#004583', fg='#ECB819')
Result_3_DB.pack()
Result_4_DB = Label(Results_1_page, text='Predicted number of hits: ', bg='#004583', fg='#ECB819')
Result_4_DB.pack()
Result_5_DB = Label(Results_1_page, text="Predicted team's winning percentage: ", bg='#004583', fg='#ECB819')
Result_5_DB.pack()
Result_6_DB = Label(Results_1_page, text='Predicted percentage of 4-0 per game: ', bg='#004583', fg='#ECB819')
Result_6_DB.pack()
Result_7_DB = Label(Results_1_page, text='Predicted percentage of 4-1 per game: ', bg='#004583', fg='#ECB819')
Result_7_DB.pack()
Result_8_DB = Label(Results_1_page, text='Predicted percentage of 4-2 per game: ', bg='#004583', fg='#ECB819')
Result_8_DB.pack()
Result_9_DB = Label(Results_1_page, text='Predicted percentage of 4-3 per game: ', bg='#004583', fg='#ECB819')
Result_9_DB.pack()
Result_10_DB = Label(Results_1_page, text='Predicted percentage of 4-4 per game: ', bg='#004583', fg='#ECB819')
Result_10_DB.pack()
Result_11_DB = Label(Results_1_page, text='Number of games the player will contribute to the team out of 22 games: ', bg='#004583', fg='#ECB819')
Result_11_DB.pack()
Result_12_DB = Label(Results_1_page, text="Number of games the player will contribute to the team's victory out of 22 games: ", bg='#004583', fg='#ECB819')
Result_12_DB.pack()
...
Title_result_D = Label(Results_2_page, text='Overall result against Chunichi dragons', bg='#003377', fg='white')
Title_result_D.pack()
Result_1_D = Label(Results_2_page, text='Predicted batting average: ', bg='#003377', fg='red')
Result_1_D.pack()
Result_2_D = Label(Results_2_page, text='Predicted number of homeruns: ', bg='#003377', fg='red')
Result_2_D.pack()
Result_3_D = Label(Results_2_page, text='Predicted RBI: ', bg='#003377', fg='red')
Result_3_D.pack()
Result_4_D = Label(Results_2_page, text='Predicted number of hits: ', bg='#003377', fg='red')
Result_4_D.pack()
Result_5_D = Label(Results_2_page, text="Predicted team's winning percentage: ", bg='#003377', fg='red')
Result_5_D.pack()
Result_6_D = Label(Results_2_page, text='Predicted percentage of 4-0 per game: ', bg='#003377', fg='red')
Result_6_D.pack()
Result_7_D = Label(Results_2_page, text='Predicted percentage of 4-1 per game: ', bg='#003377', fg='red')
Result_7_D.pack()
Result_8_D = Label(Results_2_page, text='Predicted percentage of 4-2 per game: ', bg='#003377', fg='red')
Result_8_D.pack()
Result_9_D = Label(Results_2_page, text='Predicted percentage of 4-3 per game: ', bg='#003377', fg='red')
Result_9_D.pack()
Result_10_D = Label(Results_2_page, text="Predicted percentage of 4-4 per game: ", bg='#003377', fg='red')
Result_10_D.pack()
Result_11_D = Label(Results_2_page, text='Number of games the player will contribute to the team out of 22 games: ', bg='#003377', fg='red')
Result_11_D.pack()
Result_12_D = Label(Results_2_page, text="Number of games the player will contribute to the team's victory out of 22 games: ", bg='#003377', fg='red')
Result_12_D.pack()
...
Title_result_T = Label(Results_3_page, text='Overall result against Hanshin Tigers',bg='#FCE300', fg='white')
Title_result_T.pack()
Result_1_T = Label(Results_3_page, text='Predicted batting average: ', bg='#FCE300', fg='#E7360C')
Result_1_T.pack()
Result_2_T = Label(Results_3_page, text='Predicted number of homeruns: ', bg='#FCE300', fg='#E7360C')
Result_2_T.pack()
Result_3_T = Label(Results_3_page, text='Predicted RBI: ', bg='#FCE300', fg='#E7360C')
Result_3_T.pack()
Result_4_T = Label(Results_3_page, text='Predicted number of hits: ', bg='#FCE300', fg='#E7360C')
Result_4_T.pack()
Result_5_T = Label(Results_3_page, text="Predicted team's winning percentage: ", bg='#FCE300', fg='#E7360C')
Result_5_T.pack()
Result_6_T = Label(Results_3_page, text='Predicted percentage of 4-0 per game: ', bg='#FCE300', fg='#E7360C')
Result_6_T.pack()
Result_7_T = Label(Results_3_page, text='Predicted percentage of 4-1 per game: ', bg='#FCE300', fg='#E7360C')
Result_7_T.pack()
Result_8_T = Label(Results_3_page, text='Predicted percentage of 4-2 per game: ', bg='#FCE300', fg='#E7360C')
Result_8_T.pack()
Result_9_T = Label(Results_3_page, text='Predicted percentage of 4-3 per game: ', bg='#FCE300', fg='#E7360C')
Result_9_T.pack()
Result_10_T = Label(Results_3_page, text="Predicted percentage of 4-4 per game: ", bg='#FCE300', fg='#E7360C')
Result_10_T.pack()
Result_11_T = Label(Results_3_page, text='Number of games the player will contribute to the team out of 22 games: ', bg='#FCE300', fg='#E7360C')
Result_11_T.pack()
Result_12_T = Label(Results_3_page, text="Number of games the player will contribute to the team's victory out of 22 games: ", bg='#FCE300', fg='#E7360C')
Result_12_T.pack()
...
Title_result_C = Label(Results_4_page, text='Overall result against Hiroshima Toyo Carp', bg='#E70012', fg='white')
Title_result_C.pack()
Result_1_C = Label(Results_4_page, text='Predicted batting average: ', bg='#E70012', fg='#053365')
Result_1_C.pack()
Result_2_C = Label(Results_4_page, text='Predicted number of homeruns: ', bg='#E70012', fg='#053365')
Result_2_C.pack()
Result_3_C = Label(Results_4_page, text='Predicted RBI: ', bg='#E70012', fg='#053365')
Result_3_C.pack()
Result_4_C = Label(Results_4_page, text='Predicted number of hits: ', bg='#E70012', fg='#053365')
Result_4_C.pack()
Result_5_C = Label(Results_4_page, text="Predicted team's winning percentage: ", bg='#E70012', fg='#053365')
Result_5_C.pack()
Result_6_C = Label(Results_4_page, text='Predicted percentage of 4-0 per game: ', bg='#E70012', fg='#053365')
Result_6_C.pack()
Result_7_C = Label(Results_4_page, text='Predicted percentage of 4-1 per game: ', bg='#E70012', fg='#053365')
Result_7_C.pack()
Result_8_C = Label(Results_4_page, text='Predicted percentage of 4-2 per game: ', bg='#E70012', fg='#053365')
Result_8_C.pack()
Result_9_C = Label(Results_4_page, text='Predicted percentage of 4-3 per game: ', bg='#E70012', fg='#053365')
Result_9_C.pack()
Result_10_C = Label(Results_4_page, text='Predicted percentage of 4-4 per game: ', bg='#E70012', fg='#053365')
Result_10_C.pack()
Result_11_C = Label(Results_4_page, text='Number of games the player will contribute to the team out of 22 games: ', bg='#E70012', fg='#053365')
Result_11_C.pack()
Result_12_C = Label(Results_4_page, text="Number of games the player will contribute to the team's victory out of 22 games: ", bg='#E70012', fg='#053365')
Result_12_C.pack()
...
Title_result_G = Label(Results_5_page, text='Overall result against Yomiuri Giants', bg='#F49C00', fg='white')
Title_result_G.pack()
Result_1_G = Label(Results_5_page, text='Predicted batting average: ', bg='#F49C00', fg='#221815')
Result_1_G.pack()
Result_2_G = Label(Results_5_page, text='Predicted number of homeruns: ', bg='#F49C00', fg='#221815')
Result_2_G.pack()
Result_3_G = Label(Results_5_page, text='Predicted RBI: ', bg='#F49C00', fg='#221815')
Result_3_G.pack()
Result_4_G = Label(Results_5_page, text='Predicted number of hits: ', bg='#F49C00', fg='#221815')
Result_4_G.pack()
Result_5_G = Label(Results_5_page, text="Predicted team's winning percentage: ", bg='#F49C00', fg='#221815')
Result_5_G.pack()
Result_6_G = Label(Results_5_page, text='Predicted percentage of 4-0 per game: ', bg='#F49C00', fg='#221815')
Result_6_G.pack()
Result_7_G = Label(Results_5_page, text='Predicted percentage of 4-1 per game: ', bg='#F49C00', fg='#221815')
Result_7_G.pack()
Result_8_G = Label(Results_5_page, text='Predicted percentage of 4-2 per game: ', bg='#F49C00', fg='#221815')
Result_8_G.pack()
Result_9_G = Label(Results_5_page, text='Predicted percentage of 4-3 per game: ', bg='#F49C00', fg='#221815')
Result_9_G.pack()
Result_10_G = Label(Results_5_page, text='Predicted percentage of 4-4 per game: ', bg='#F49C00', fg='#221815')
Result_10_G.pack()
Result_11_G = Label(Results_5_page, text='Number of games the player will contribute to the team out of 22 games: ', bg='#F49C00', fg='#221815')
Result_11_G.pack()
Result_12_G = Label(Results_5_page, text="Number of games the player will contribute to the team's victory out of 22 games: ", bg='#F49C00', fg='#221815')
Result_12_G.pack()
...
Title = Label(Results_6_page, text='Overall results compared with opponent pitcher and fielders', bg='#00A051', fg='white')
Title.pack()
...
Back_6.pack()
Reset = Button(Results_6_page, text='Choose new player', command=lambda: start_page.tkraise())
Reset.pack()
...
def calculation(player, year):
    ...
    databases = {c_1:'stats_a', c_2:'stats_b', c_3:'stats_c', c_4:'stats_d', c_5:'stats_e', c_14:'stats_win_lose'}

    for table in databases:
        table.execute(f"SELECT * from {databases[table]}")
    ...
    class Player_Total:
        def __init__(self, bat_2024, hit_2024, HR_2024, RBI_2024, injury_2024, bat_2023, hit_2023, HR_2023, RBI_2023, injury_2023, bat_2022,
                     hit_2022, HR_2022, RBI_2022, bat_2021, hit_2021, HR_2021, RBI_2021, bat_2020, hit_2020, HR_2020,
                     RBI_2020):
        ...
        def organize_stats(player):
            return [player.bat_2024, player.hit_2024, player.HR_2024, player.RBI_2024, player.injury_2024, player.bat_2023, player.hit_2023, player.HR_2023,
                    player.RBI_2023, player.injury_2023, player.bat_2022, player.hit_2022, player.HR_2022, player.RBI_2022, player.bat_2021, player.hit_2021,
                    player.HR_2021, player.RBI_2021, player.bat_2020, player.hit_2020, player.HR_2020, player.RBI_2020]


    indexes_5 = [0,1,4,5,6]
    player_data_5 = []

    for index in indexes_5:
        data = Player_Total(data_2024[index][1], data_2024[index][2], data_2024[index][4], data_2024[index][5], data_2024[index][6], data_2023[index][1],
                                       data_2023[index][2], data_2023[index][4], data_2023[index][5], data_2023[index][6], data_2022[index][1],
                                       data_2022[index][2], data_2022[index][4], data_2022[index][5], data_2021[index][1], data_2021[index][2],
                                       data_2021[index][4], data_2021[index][5], data_2020[index][1], data_2020[index][2], data_2020[index][4],
                                       data_2020[index][5])
        player = data.organize_stats()
        player_data_5.append(player)

    player_1_Murakami = player_data_5[0]
    player_2_Yamada = player_data_5[1]
    player_5_Aoki = player_data_5[2]
    player_6_Shiomi = player_data_5[3]
    player_7_Nakamura = player_data_5[4]
    ...
    for index in range(3,5):
        data = Player_Total(data_2024[index][1], data_2024[index][2], data_2024[index][4], data_2024[index][5], data_2024[index][6], data_2023[index][1],
                                       data_2023[index][2], data_2023[index][4], data_2023[index][5], data_2023[index][6], data_2022[index][1],
                                       data_2022[index][2], data_2022[index][4], data_2022[index][5], data_2021[index][1], data_2021[index][2],
                                       data_2021[index][4], data_2021[index][5], None, None, None, None)
        player = data.organize_stats()
        player_data_4.append(player)

    player_3_Santana = player_data_4[0]
    player_4_Osuna = player_data_4[1]

    data_8_Nagaoka = Player_Total(data_2024[7][1], data_2024[7][2], data_2024[7][4], data_2024[7][5], data_2024[7][6], data_2023[7][1], data_2023[7][2],
                                    data_2023[7][4], data_2023[7][5], data_2023[7][6], data_2022[7][1], data_2022[7][2], data_2022[7][4], data_2022[7][5],
                                    None, None, None, None, None, None, None, None)
    player_8_Nagaoka = data_8_Nagaoka.organize_stats()

    if year == 3:
        data_win = c_14.fetchall()
        total_percentage = (data_win[0][1] + data_win[6][1] + data_win[12][1]) / (data_win[0][1] + data_win[6][1] + data_win[12][1] + data_win[0][2] +
                                                                                  data_win[6][2] + data_win[12][2])

        if index == 0:
            batting = (player_1_Murakami[1] + player_1_Murakami[6] + player_1_Murakami[11]) / (player_1_Murakami[0] + player_1_Murakami[5] +
                                                                                               player_1_Murakami[10])
            prob_4_4, prob_4_3, prob_4_2, prob_4_1 = ((batting ** 4), (batting ** 3) * (1 - batting) * 4, (batting ** 2) * ((1 - batting) ** 2) * 6,
                                                      (batting) * ((1 - batting) ** 3) * 4)

            RBI_to_hit_ratio = (player_1_Murakami[3] + player_1_Murakami[8] + player_1_Murakami[13]) / (player_1_Murakami[1] + player_1_Murakami[6] +
                                                                                                        player_1_Murakami[11])
            Homerun_to_hit_ratio = (player_1_Murakami[2] + player_1_Murakami[7] + player_1_Murakami[12]) / (player_1_Murakami[1] + player_1_Murakami[6] +
                                                                                                            player_1_Murakami[11])

            predicted_total_games_played = 143 - ((player_1_Murakami[9] + player_1_Murakami[4]) / 2)

        elif index == 1:
            batting = (player_2_Yamada[1] + player_2_Yamada[6] + player_2_Yamada[11]) / (player_2_Yamada[0] + player_2_Yamada[5] + player_2_Yamada[10])
            prob_4_4, prob_4_3, prob_4_2, prob_4_1 = ((batting ** 4), (batting ** 3) * (1 - batting) * 4, (batting ** 2) * ((1 - batting) ** 2) * 6,
                                                      (batting) * ((1 - batting) ** 3) * 4)

            RBI_to_hit_ratio = (player_2_Yamada[3] + player_2_Yamada[8] + player_2_Yamada[13]) / (player_2_Yamada[1] + player_2_Yamada[6] +
                                                                                                  player_2_Yamada[11])
            Homerun_to_hit_ratio = (player_2_Yamada[2] + player_2_Yamada[7] + player_2_Yamada[12]) / (player_2_Yamada[1] + player_2_Yamada[6] +
                                                                                                      player_2_Yamada[11])

            predicted_total_games_played = 143 - ((player_2_Yamada[9] + player_2_Yamada[4]) / 2)

        elif index == 2:
            batting = (player_3_Santana[1] + player_3_Santana[6] + player_3_Santana[11]) / (player_3_Santana[0] + player_3_Santana[5] + player_3_Santana[10])
            prob_4_4, prob_4_3, prob_4_2, prob_4_1 = ((batting ** 4), (batting ** 3) * (1 - batting) * 4, (batting ** 2) * ((1 - batting) ** 2) * 6,
                                                      (batting) * ((1 - batting) ** 3) * 4)

            RBI_to_hit_ratio = (player_3_Santana[3] + player_3_Santana[8] + player_3_Santana[13]) / (player_3_Santana[1] + player_3_Santana[6] +
                                                                                                     player_3_Santana[11])
            Homerun_to_hit_ratio = (player_3_Santana[2] + player_3_Santana[7] + player_3_Santana[12]) / (player_3_Santana[1] + player_3_Santana[6] +
                                                                                                         player_3_Santana[11])

            predicted_total_games_played = 143 - ((player_3_Santana[9] + player_3_Santana[4]) / 2)

        elif index == 3:
            batting = (player_4_Osuna[1] + player_4_Osuna[6] + player_4_Osuna[11]) / (player_4_Osuna[0] + player_4_Osuna[5] + player_4_Osuna[10])
            prob_4_4, prob_4_3, prob_4_2, prob_4_1 = ((batting ** 4), (batting ** 3) * (1 - batting) * 4, (batting ** 2) * ((1 - batting) ** 2) * 6,
                                                      (batting) * ((1 - batting) ** 3) * 4)

            RBI_to_hit_ratio = (player_4_Osuna[3] + player_4_Osuna[8] + player_4_Osuna[13]) / (player_4_Osuna[1] + player_4_Osuna[6] + player_4_Osuna[11])
            Homerun_to_hit_ratio = (player_4_Osuna[2] + player_4_Osuna[7] + player_4_Osuna[12]) / (player_4_Osuna[1] + player_4_Osuna[6] + player_4_Osuna[11])

            predicted_total_games_played = 143 - ((player_4_Osuna[4] + player_4_Osuna[9]) / 2)

        elif index == 4:
            batting = (player_5_Aoki[1] + player_5_Aoki[6] + player_5_Aoki[11]) / (player_5_Aoki[0] + player_5_Aoki[5] + player_5_Aoki[10])
            prob_4_4, prob_4_3, prob_4_2, prob_4_1 = ((batting ** 4), (batting ** 3) * (1 - batting) * 4, (batting ** 2) * ((1 - batting) ** 2) * 6,
                                                      (batting) * ((1 - batting) ** 3) * 4)

            RBI_to_hit_ratio = (player_5_Aoki[3] + player_5_Aoki[8] + player_5_Aoki[13]) / (player_5_Aoki[1] + player_5_Aoki[6] + player_5_Aoki[11])
            Homerun_to_hit_ratio = (player_5_Aoki[2] + player_5_Aoki[7] + player_5_Aoki[12]) / (player_5_Aoki[1] + player_5_Aoki[6] + player_5_Aoki[11])

            predicted_total_games_played = 143 - ((player_5_Aoki[4] + player_5_Aoki[9]) / 2)

        elif index == 5:
            batting = (player_6_Shiomi[1] + player_6_Shiomi[6] + player_6_Shiomi[11]) / (player_6_Shiomi[0] + player_6_Shiomi[5] + player_6_Shiomi[10])
            prob_4_4, prob_4_3, prob_4_2, prob_4_1 = ((batting ** 4), (batting ** 3) * (1 - batting) * 4, (batting ** 2) * ((1 - batting) ** 2) * 6,
                                                      (batting) * ((1 - batting) ** 3) * 4)

            RBI_to_hit_ratio = (player_6_Shiomi[3] + player_6_Shiomi[8] + player_6_Shiomi[13]) / (player_6_Shiomi[1] + player_6_Shiomi[6] +
                                                                                                  player_6_Shiomi[11])
            Homerun_to_hit_ratio = (player_6_Shiomi[2] + player_6_Shiomi[7] + player_6_Shiomi[12]) / (player_6_Shiomi[1] + player_6_Shiomi[6] +
                                                                                                      player_6_Shiomi[11])

            predicted_total_games_played = 143 - ((player_6_Shiomi[4] + player_6_Shiomi[9]) / 2)

        elif index == 6:
            batting = (player_7_Nakamura[1] + player_7_Nakamura[6] + player_7_Nakamura[11]) / (player_7_Nakamura[0] + player_7_Nakamura[5] +
                                                                                               player_7_Nakamura[10])
            prob_4_4, prob_4_3, prob_4_2, prob_4_1 = ((batting ** 4), (batting ** 3) * (1 - batting) * 4, (batting ** 2) * ((1 - batting) ** 2) * 6,
                                                      (batting) * ((1 - batting) ** 3) * 4)

            RBI_to_hit_ratio = (player_7_Nakamura[3] + player_7_Nakamura[8] + player_7_Nakamura[13]) / (player_7_Nakamura[1] + player_7_Nakamura[6] +
                                                                                                        player_7_Nakamura[11])
            Homerun_to_hit_ratio = (player_7_Nakamura[2] + player_7_Nakamura[7] + player_7_Nakamura[12]) / (player_7_Nakamura[1] + player_7_Nakamura[6] +
                                                                                                            player_7_Nakamura[11])

            predicted_total_games_played = 143 - ((player_7_Nakamura[4] + player_7_Nakamura[9]) / 2)

        elif index == 7:
            batting = (player_8_Nagaoka[1] + player_8_Nagaoka[6] + player_8_Nagaoka[11]) / (player_8_Nagaoka[0] + player_8_Nagaoka[5] + player_8_Nagaoka[10])
            prob_4_4, prob_4_3, prob_4_2, prob_4_1 = ((batting ** 4), (batting ** 3) * (1 - batting) * 4, (batting ** 2) * ((1 - batting) ** 2) * 6,
                                                      (batting) * ((1 - batting) ** 3) * 4)

            RBI_to_hit_ratio = (player_8_Nagaoka[3] + player_8_Nagaoka[8] + player_8_Nagaoka[13]) / (player_8_Nagaoka[1] + player_8_Nagaoka[6] +
                                                                                                     player_8_Nagaoka[11])
            Homerun_to_hit_ratio = (player_8_Nagaoka[2] + player_8_Nagaoka[7] + player_8_Nagaoka[12]) / (player_8_Nagaoka[1] + player_8_Nagaoka[6] +
                                                                                                         player_8_Nagaoka[11])

            predicted_total_games_played = 143 - ((player_8_Nagaoka[4] + player_8_Nagaoka[9]) / 2)
        ...
        if index == 0:
            batting = (player_1_Murakami[1] + player_1_Murakami[6] + player_1_Murakami[11]+ player_1_Murakami[15]) / (player_1_Murakami[0] + player_1_Murakami[5] + player_1_Murakami[10]+ player_1_Murakami[14])
            ...
            RBI_to_hit_ratio = (player_1_Murakami[3] + player_1_Murakami[8] + player_1_Murakami[13] + player_1_Murakami[17]) / (player_1_Murakami[1] + player_1_Murakami[6] + player_1_Murakami[11]+ player_1_Murakami[15])
            Homerun_to_hit_ratio = (player_1_Murakami[2] + player_1_Murakami[7] + player_1_Murakami[12] + player_1_Murakami[16]) / (player_1_Murakami[1] + player_1_Murakami[6] + player_1_Murakami[11]+ player_1_Murakami[15])

            predicted_total_games_played = 143 - ((player_1_Murakami[4] + player_1_Murakami[9])/2)

        elif index == 1:
            batting = (player_2_Yamada[1] + player_2_Yamada[6] + player_2_Yamada[11] + player_2_Yamada[15]) / (player_2_Yamada[0] + player_2_Yamada[5] + player_2_Yamada[10] + player_2_Yamada[14])
            ...
            RBI_to_hit_ratio = (player_2_Yamada[3] + player_2_Yamada[8] + player_2_Yamada[13] + player_2_Yamada[17]) / (player_2_Yamada[1] + player_2_Yamada[6] + player_2_Yamada[11] + player_2_Yamada[15])
            Homerun_to_hit_ratio = (player_2_Yamada[2] + player_2_Yamada[7] + player_2_Yamada[12] + player_2_Yamada[16]) / (player_2_Yamada[1] + player_2_Yamada[6] + player_2_Yamada[11] + player_2_Yamada[15])

            predicted_total_games_played = 143 - ((player_2_Yamada[4] + player_2_Yamada[9]) / 2)

        elif index == 2:
            batting = (player_3_Santana[1] + player_3_Santana[6] + player_3_Santana[11] + player_3_Santana[15]) / (player_3_Santana[0] + player_3_Santana[5] + player_3_Santana[10] + player_3_Santana[14])
            ...
            RBI_to_hit_ratio = (player_3_Santana[3] + player_3_Santana[8] + player_3_Santana[13] + player_3_Santana[17]) / (player_3_Santana[1] + player_3_Santana[6] + player_3_Santana[11] + player_3_Santana[15])
            Homerun_to_hit_ratio = (player_3_Santana[2] + player_3_Santana[7] + player_3_Santana[12] + player_3_Santana[16]) / (player_3_Santana[1] + player_3_Santana[6] + player_3_Santana[11] + player_3_Santana[15])

            predicted_total_games_played = 143 - ((player_3_Santana[4] + player_3_Santana[9]) / 2)

        elif index == 3:
            batting = (player_4_Osuna[1] + player_4_Osuna[6] + player_4_Osuna[11] + player_4_Osuna[15]) / (player_4_Osuna[0] + player_4_Osuna[5] + player_4_Osuna[10] + player_4_Osuna[14])
            ...
            RBI_to_hit_ratio = (player_4_Osuna[3] + player_4_Osuna[8] + player_4_Osuna[13] + player_4_Osuna[17]) / (player_4_Osuna[1] + player_4_Osuna[6] + player_4_Osuna[11] + player_4_Osuna[15])
            Homerun_to_hit_ratio = (player_4_Osuna[2] + player_4_Osuna[7] + player_4_Osuna[12] + player_4_Osuna[16]) / (player_4_Osuna[1] + player_4_Osuna[6] + player_4_Osuna[11] + player_4_Osuna[15])

            predicted_total_games_played = 143 - ((player_4_Osuna[4] + player_4_Osuna[9]) / 2)

        elif index == 4:
            batting = (player_5_Aoki[1] + player_5_Aoki[6] + player_5_Aoki[11] + player_5_Aoki[15]) / (player_5_Aoki[0] + player_5_Aoki[5] + player_5_Aoki[10] + player_5_Aoki[14])
            ...
            RBI_to_hit_ratio = (player_5_Aoki[3] + player_5_Aoki[8] + player_5_Aoki[13] + player_5_Aoki[17]) / (player_5_Aoki[1] + player_5_Aoki[6] + player_5_Aoki[11] + player_5_Aoki[15])
            Homerun_to_hit_ratio = (player_5_Aoki[2] + player_5_Aoki[7] + player_5_Aoki[12] + player_5_Aoki[16]) / (player_5_Aoki[1] + player_5_Aoki[6] + player_5_Aoki[11] + player_5_Aoki[15])

            predicted_total_games_played = 143 - ((player_5_Aoki[4] + player_5_Aoki[9]) / 2)

        elif index == 5:
            batting = (player_6_Shiomi[1] + player_6_Shiomi[6] + player_6_Shiomi[11] + player_6_Shiomi[15]) / (player_6_Shiomi[0] + player_6_Shiomi[5] + player_6_Shiomi[10] + player_6_Shiomi[14])
            ...
            RBI_to_hit_ratio = (player_6_Shiomi[3] + player_6_Shiomi[8] + player_6_Shiomi[13] + player_6_Shiomi[17]) / (player_6_Shiomi[1] + player_6_Shiomi[6] + player_6_Shiomi[11] + player_6_Shiomi[15])
            Homerun_to_hit_ratio = (player_6_Shiomi[2] + player_6_Shiomi[7] + player_6_Shiomi[12] + player_6_Shiomi[16]) / (player_6_Shiomi[1] + player_6_Shiomi[6] + player_6_Shiomi[11] + player_6_Shiomi[15])

            predicted_total_games_played = 143 - ((player_6_Shiomi[4] + player_6_Shiomi[9]) / 2)

        elif index == 6:
            batting = (player_7_Nakamura[1] + player_7_Nakamura[6] + player_7_Nakamura[11] + player_7_Nakamura[15]) / (player_7_Nakamura[0] + player_7_Nakamura[5] + player_7_Nakamura[10] + player_7_Nakamura[14])
            ...
            RBI_to_hit_ratio = (player_7_Nakamura[3] + player_7_Nakamura[8] + player_7_Nakamura[13] + player_7_Nakamura[17]) / (player_7_Nakamura[1] + player_7_Nakamura[6] + player_7_Nakamura[11] + player_7_Nakamura[15])
            Homerun_to_hit_ratio = (player_7_Nakamura[2] + player_7_Nakamura[7] + player_7_Nakamura[12] + player_7_Nakamura[16]) / (player_7_Nakamura[1] + player_7_Nakamura[6] + player_7_Nakamura[11] + player_7_Nakamura[15])
            ...
            prob_4_4, prob_4_3, prob_4_2, prob_4_1 = (batting ** 4), (batting ** 3) * (1 - batting) * 4, (batting ** 2) * ((1 - batting) ** 2) * 6, (batting) * ((1 - batting) ** 3) * 4

            RBI_to_hit_ratio = (player_8_Nagaoka[3] + player_8_Nagaoka[8] + player_8_Nagaoka[13]) / (player_8_Nagaoka[1] + player_8_Nagaoka[6] + player_8_Nagaoka[11])

            Homerun_to_hit_ratio = (player_8_Nagaoka[2] + player_8_Nagaoka[7] + player_8_Nagaoka[12]) / (player_8_Nagaoka[1] + player_8_Nagaoka[6] + player_8_Nagaoka[11])
        ...
        if index == 0:
            ...
            batting = (player_1_Murakami[1] + player_1_Murakami[6] + player_1_Murakami[11] + player_1_Murakami[15] + player_1_Murakami[19]) / (player_1_Murakami[0] + player_1_Murakami[5] + player_1_Murakami[10] + player_1_Murakami[14] + player_1_Murakami[18])
            ...
            RBI_to_hit_ratio = (player_1_Murakami[3] + player_1_Murakami[8] + player_1_Murakami[13] + player_1_Murakami[17] + player_1_Murakami[21]) / (player_1_Murakami[1] + player_1_Murakami[6] + player_1_Murakami[11] + player_1_Murakami[15] + player_1_Murakami[19])
            Homerun_to_hit_ratio = (player_1_Murakami[2] + player_1_Murakami[7] + player_1_Murakami[12] + player_1_Murakami[16] + player_1_Murakami[20]) / (player_1_Murakami[1] + player_1_Murakami[6] + player_1_Murakami[11] + player_1_Murakami[15] + player_1_Murakami[19])

            predicted_total_games_played = 143 - ((player_1_Murakami[4] + player_1_Murakami[9]) / 2)

        elif index == 1:

            batting = (player_2_Yamada[1] + player_2_Yamada[6] + player_2_Yamada[11] + player_2_Yamada[15] + player_2_Yamada[19]) / (player_2_Yamada[0] + player_2_Yamada[5] + player_2_Yamada[10] + player_2_Yamada[14] + player_2_Yamada[18])
            ...
            RBI_to_hit_ratio = (player_2_Yamada[3] + player_2_Yamada[8] + player_2_Yamada[13] + player_2_Yamada[17] + player_2_Yamada[21]) / (player_2_Yamada[1] + player_2_Yamada[6] + player_2_Yamada[11] + player_2_Yamada[15] + player_2_Yamada[19])
            Homerun_to_hit_ratio = (player_2_Yamada[2] + player_2_Yamada[7] + player_2_Yamada[12] + player_2_Yamada[16] + player_2_Yamada[20]) / (player_2_Yamada[1] + player_2_Yamada[6] + player_2_Yamada[11] + player_2_Yamada[15] + player_2_Yamada[19])
            ...
            batting = (player_5_Aoki[1] + player_5_Aoki[6] + player_5_Aoki[11] + player_5_Aoki[15] + player_5_Aoki[19] / (player_5_Aoki[0] + player_5_Aoki[5] + player_5_Aoki[10] + player_5_Aoki[14] + player_5_Aoki[18]))
            ...
            RBI_to_hit_ratio = (player_5_Aoki[3] + player_5_Aoki[8] + player_5_Aoki[13] + player_5_Aoki[17] + player_5_Aoki[21]) / (player_5_Aoki[1] + player_5_Aoki[6] + player_5_Aoki[11] + player_5_Aoki[15] + player_5_Aoki[19])
            Homerun_to_hit_ratio = (player_5_Aoki[2] + player_5_Aoki[7] + player_5_Aoki[12] + player_5_Aoki[16] + player_5_Aoki[20]) / (player_5_Aoki[1] + player_5_Aoki[6] + player_5_Aoki[11] + player_5_Aoki[15] + player_5_Aoki[19])

            predicted_total_games_played = 143 - ((player_5_Aoki[4] + player_5_Aoki[9]) / 2)

        elif index == 5:

            batting = (player_6_Shiomi[1] + player_6_Shiomi[6] + player_6_Shiomi[11] + player_6_Shiomi[15] + player_6_Shiomi[19]) / (player_6_Shiomi[0] + player_6_Shiomi[5] + player_6_Shiomi[10] + player_6_Shiomi[14] + player_6_Shiomi[18])
            ...
            RBI_to_hit_ratio = (player_6_Shiomi[3] + player_6_Shiomi[8] + player_6_Shiomi[13] + player_6_Shiomi[17] + player_6_Shiomi[21]) / (player_6_Shiomi[1] + player_6_Shiomi[6] + player_6_Shiomi[11] + player_6_Shiomi[15] + player_6_Shiomi[19])
            Homerun_to_hit_ratio = (player_6_Shiomi[2] + player_6_Shiomi[7] + player_6_Shiomi[12] + player_6_Shiomi[16] + player_6_Shiomi[20]) / (player_6_Shiomi[1] + player_6_Shiomi[6] + player_6_Shiomi[11] + player_6_Shiomi[15] + player_6_Shiomi[19])

            predicted_total_games_played = 143 - ((player_6_Shiomi[4] + player_6_Shiomi[9]) / 2)

        elif index == 6:

            batting = (player_7_Nakamura[1] + player_7_Nakamura[6] + player_7_Nakamura[11] + player_7_Nakamura[15] + player_7_Nakamura[19]) / (player_7_Nakamura[0] + player_7_Nakamura[5] + player_7_Nakamura[10] + player_7_Nakamura[14] + player_7_Nakamura[18])
            ...
            RBI_to_hit_ratio = (player_7_Nakamura[3] + player_7_Nakamura[8] + player_7_Nakamura[13] + player_7_Nakamura[17] + player_7_Nakamura[21]) / (player_7_Nakamura[1] + player_7_Nakamura[6] + player_7_Nakamura[11] + player_7_Nakamura[15] + player_7_Nakamura[19])
            Homerun_to_hit_ratio = (player_7_Nakamura[2] + player_7_Nakamura[7] + player_7_Nakamura[12] + player_7_Nakamura[16] + player_7_Nakamura[20]) / (player_7_Nakamura[1] + player_7_Nakamura[6] + player_7_Nakamura[11] + player_7_Nakamura[15] + player_7_Nakamura[19])
    ...
    for prob_2 in probabilities:
        Total_number_of_games_contribution += (predicted_total_games_played * prob_2 * (1 - (1-f) ** counter))
        counter += 1

    result = [round(batting, 3), int(total_predicted_homerun), int(total_predicted_RBI),
              int(total_predicted_hit), round(total_percentage, 3), round((1 - (prob_4_4 + prob_4_3 + prob_4_2 + prob_4_1)), 3),
              round(prob_4_1, 3), round(prob_4_2, 3), round(prob_4_3, 3), round(prob_4_4, 3), int(Total_number_of_games_contribution),
...
def Murakami(year):
    ...
    def Murakami_calculations(batting_DB, batting_D, batting_T, batting_C, batting_G, RBI_to_hit_ratio_DB,RBI_to_hit_ratio_D, RBI_to_hit_ratio_T, RBI_to_hit_ratio_C, RBI_to_hit_ratio_G,Homerun_to_hit_ratio_DB, Homerun_to_hit_ratio_D, Homerun_to_hit_ratio_T,Homerun_to_hit_ratio_C, Homerun_to_hit_ratio_G, win_percentage_DB, win_percentage_D, win_percentage_T, win_percentage_C, win_percentage_G):
        ...
        for i in range(5):
            ...
            counter = 1
            for prob_2 in probabilities:
                Total_number_of_games_contribution += (prob_2 * (1 - (1 - f) ** counter) * predicted_total_games_played)
                counter += 1
        ...
        return [Predicted_homerun_by_team, Predicted_RBI_by_team, Predicted_hit_by_team, Predicted_4_1_by_team, Predicted_4_2_by_team,
                Predicted_4_3_by_team, Predicted_4_4_by_team, Total_number_of_games_contribution_by_team, Total_number_of_games_contribution_victory_by_team]
    ...
    if year == 5:
        x = Murakami_calculations(batting_DB_5, batting_D_5, batting_T_5, batting_C_5, batting_G_5, RBI_to_hit_ratio_DB_5,RBI_to_hit_ratio_D_5,
                                  RBI_to_hit_ratio_T_5, RBI_to_hit_ratio_C_5, RBI_to_hit_ratio_G_5,Homerun_to_hit_ratio_DB_5, Homerun_to_hit_ratio_D_5,
                                  Homerun_to_hit_ratio_T_5,Homerun_to_hit_ratio_C_5, Homerun_to_hit_ratio_G_5, win_percentage_5_DB, win_percentage_5_D,
                                  win_percentage_5_T, win_percentage_5_C, win_percentage_5_G)
        result_DB = [round(batting_DB_5, 3), int(x[0][0]), int(x[1][0]), int(x[2][0]), round(win_percentage_5_DB, 3),
                     round(1 - (x[3][0] + x[4][0] + x[5][0] + x[6][0]), 3), round(x[3][0], 3), round(x[4][0], 3), round(x[5][0], 3), round(x[6][0], 3),
                     int(x[7][0]), int(x[8][0])]
        result_D = [round(batting_D_5, 3), int(x[0][1]), int(x[1][1]), int(x[2][1]), round(win_percentage_5_D, 3),
                    round(1 - (x[3][1] + x[4][1] + x[5][1] + x[6][1]), 3), round(x[3][1], 3), round(x[4][1], 3), round(x[5][1], 3), round(x[6][1], 3),
                    int(x[7][1]), int(x[8][1])]
        result_T = [round(batting_T_5, 3), int(x[0][2]), int(x[1][2]), int(x[2][2]), round(win_percentage_5_T, 3),
                    round(1 - (x[3][2] + x[4][2] + x[5][2] + x[6][2]), 3), round(x[3][2], 3), round(x[4][2], 3), round(x[5][2], 3), round(x[6][2], 3),
                    int(x[7][2]), int(x[8][2])]
        result_C = [round(batting_C_5, 3), int(x[0][3]), int(x[1][3]), int(x[2][3]), round(win_percentage_5_C, 3),
                    round(1 - (x[3][3] + x[4][3] + x[5][3] + x[6][3]), 3), round(x[3][3], 3), round(x[4][3], 3), round(x[5][3], 3), round(x[6][3], 3),
                    int(x[7][3]), int(x[8][3])]
        result_G = [round(batting_G_5, 3), int(x[0][4]), int(x[1][4]), int(x[2][4]), round(win_percentage_5_G, 3),
                    round(1 - (x[3][4] + x[4][4] + x[5][4] + x[6][4]), 3), round(x[3][4], 3), round(x[4][4], 3), round(x[5][4], 3), round(x[6][4], 3),
                    int(x[7][4]), int(x[8][4])]
        return [result_DB, result_D, result_T, result_C, result_G]

    elif year == 4:
        x = Murakami_calculations(batting_DB_4, batting_D_4, batting_T_4, batting_C_4, batting_G_4, RBI_to_hit_ratio_DB_4,RBI_to_hit_ratio_D_4,
                                  RBI_to_hit_ratio_T_4, RBI_to_hit_ratio_C_4, RBI_to_hit_ratio_G_4,Homerun_to_hit_ratio_DB_4, Homerun_to_hit_ratio_D_4,
                                  Homerun_to_hit_ratio_T_4,Homerun_to_hit_ratio_C_4, Homerun_to_hit_ratio_G_4, win_percentage_4_DB, win_percentage_4_D,
                                  win_percentage_4_T, win_percentage_4_C, win_percentage_4_G)
        result_DB = [round(batting_DB_4, 3), int(x[0][0]), int(x[1][0]), int(x[2][0]), round(win_percentage_4_DB, 3),
                     round(1 - (x[3][0] + x[4][0] + x[5][0] + x[6][0]), 3), round(x[3][0], 3), round(x[4][0], 3), round(x[5][0], 3), round(x[6][0], 3),
                     int(x[7][0]), int(x[8][0])]
        result_D = [round(batting_D_4, 3), int(x[0][1]), int(x[1][1]), int(x[2][1]), round(win_percentage_4_D, 3),
                    round(1 - (x[3][1] + x[4][1] + x[5][1] + x[6][1]), 3), round(x[3][1], 3), round(x[4][1], 3), round(x[5][1], 3), round(x[6][1], 3),
                    int(x[7][1]), int(x[8][1])]
        result_T = [round(batting_T_4, 3), int(x[0][2]), int(x[1][2]), int(x[2][2]), round(win_percentage_4_T, 3),
                    round(1 - (x[3][2] + x[4][2] + x[5][2] + x[6][2]), 3), round(x[3][2], 3), round(x[4][2], 3), round(x[5][2], 3), round(x[6][2], 3),
                    int(x[7][2]), int(x[8][2])]
        result_C = [round(batting_C_4, 3), int(x[0][3]), int(x[1][3]), int(x[2][3]), round(win_percentage_4_C, 3),
                    round(1 - (x[3][3] + x[4][3] + x[5][3] + x[6][3]), 3), round(x[3][3], 3), round(x[4][3], 3), round(x[5][3], 3), round(x[6][3], 3),
                    int(x[7][3]), int(x[8][3])]
        result_G = [round(batting_G_4, 3), int(x[0][4]), int(x[1][4]), int(x[2][4]), round(win_percentage_4_G, 3),
                    round(1 - (x[3][4] + x[4][4] + x[5][4] + x[6][4]), 3), round(x[3][4], 3), round(x[4][4], 3), round(x[5][4], 3), round(x[6][4], 3),
                    int(x[7][4]), int(x[8][4])]
        return [result_DB, result_D, result_T, result_C, result_G]

    elif year == 3:
        x = Murakami_calculations(batting_DB_3, batting_D_3, batting_T_3, batting_C_3, batting_G_3, RBI_to_hit_ratio_DB_3,RBI_to_hit_ratio_D_3,
                                  RBI_to_hit_ratio_T_3, RBI_to_hit_ratio_C_3, RBI_to_hit_ratio_G_3,Homerun_to_hit_ratio_DB_3, Homerun_to_hit_ratio_D_3,
                                  Homerun_to_hit_ratio_T_3,Homerun_to_hit_ratio_C_3, Homerun_to_hit_ratio_G_3, win_percentage_3_DB, win_percentage_3_D,
                                  win_percentage_3_T, win_percentage_3_C, win_percentage_3_G)
        result_DB = [round(batting_DB_3, 3), int(x[0][0]), int(x[1][0]), int(x[2][0]), round(win_percentage_3_DB, 3),
                     round(1 - (x[3][0] + x[4][0] + x[5][0] + x[6][0]), 3), round(x[3][0], 3), round(x[4][0], 3), round(x[5][0], 3), round(x[6][0], 3),
                     int(x[7][0]), int(x[8][0])]
        result_D = [round(batting_D_3, 3), int(x[0][1]), int(x[1][1]), int(x[2][1]), round(win_percentage_3_D, 3),
                    round(1 - (x[3][1] + x[4][1] + x[5][1] + x[6][1]), 3), round(x[3][1], 3), round(x[4][1], 3), round(x[5][1], 3), round(x[6][1], 3),
                    int(x[7][1]), int(x[8][1])]
        result_T = [round(batting_T_3, 3), int(x[0][2]), int(x[1][2]), int(x[2][2]), round(win_percentage_3_T, 3),
                    round(1 - (x[3][2] + x[4][2] + x[5][2] + x[6][2]), 3), round(x[3][2], 3), round(x[4][2], 3), round(x[5][2], 3), round(x[6][2], 3),
                    int(x[7][2]), int(x[8][2])]
        result_C = [round(batting_C_3, 3), int(x[0][3]), int(x[1][3]), int(x[2][3]), round(win_percentage_3_C, 3),
                    round(1 - (x[3][3] + x[4][3] + x[5][3] + x[6][3]), 3), round(x[3][3], 3), round(x[4][3], 3), round(x[5][3], 3), round(x[6][3], 3),
                    int(x[7][3]), int(x[8][3])]
        result_G = [round(batting_G_3, 3), int(x[0][4]), int(x[1][4]), int(x[2][4]), round(win_percentage_3_G, 3),
                    round(1 - (x[3][4] + x[4][4] + x[5][4] + x[6][4]), 3), round(x[3][4], 3), round(x[4][4], 3), round(x[5][4], 3), round(x[6][4], 3),
                    int(x[7][4]), int(x[8][4])]
        return [result_DB, result_D, result_T, result_C, result_G]
...
step = Label(instruction_page, text="Step by step instruction for the system", bg='#E6002D', fg='white')
step.pack()
step_one = Label(instruction_page, text="1. Click the start button on the start page.", bg='#E6002D', fg='white')
step_one.pack()
step_two = Label(instruction_page, text="2. Choose the player that you want the prediction of.", bg='#E6002D', fg='white')
step_two.pack()
step_three = Label(instruction_page, text="3. Choose the number of years of data the system want to use.", bg='#E6002D', fg='white')
step_three.pack()
step_four = Label(instruction_page, text="4. Go to the confirmation page and check if the input is correct.", bg='#E6002D', fg='white')
step_four.pack()
step_five = Label(instruction_page, text="5. Click the input button to display data on the next page.", bg='#E6002D', fg='white')
step_five.pack()
